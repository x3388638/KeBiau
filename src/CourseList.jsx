                ...
                this.props.filterConflict && list[val].isConflict ? null : (
                  <TableRow key={val} data-uuid={val}>
                    ...
                    <span className="TableRow__link">
                      <a
                        href={`https://ccweb6.ncnu.edu.tw/student/aspmaker_course_opened_detail_viewlist.php?cmd=search&t=aspmaker_course_opened_detail_view&x_year=${list[val].year}&x_courseid=${list[val].cid}`}
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        課綱{' '}
